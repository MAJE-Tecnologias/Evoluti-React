...
export default function Navbar() {
  ...
  return (
    <nav
      className={`fixed h-fit py-2 w-full flex px-10 justify-between items-center text-white z-50 md:px-12 transition-all duration-300 ${
        scroll ? "bg-evolutiGreen" : "bg-transparent"
      }`}
    >
      ...
      <a
        href="/cadastro"
        className="border border-white rounded-3xl py-1.5 px-10 overflow-hidden group relative"
      >
